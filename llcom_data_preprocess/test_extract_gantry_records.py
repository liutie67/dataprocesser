...
class ExtractGantryRecordsTests(unittest.TestCase):
    def test_copy_groups_files_and_renames_collisions(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_dir:
            ...
            result = extract_gantry_records(source, output)
            ...
            second_result = extract_gantry_records(source, output)
            self.assertEqual(second_result.renamed_groups, 2)
    ...
    def test_move_accepts_a_single_ai_and_leaves_unselected_files(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_dir:
            ...
            result = extract_gantry_records(source_ai, output, move=True)
